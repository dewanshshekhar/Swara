...
from empath.audio_utils import AudioSaver, save_audio
...
class AudioSaverFormatTests(unittest.TestCase):
    ...
    def test_save_audio_validates_opus_format(self):
        ...
        with patch('empath.audio_utils.torchaudio.save') as mock_save:
    ...
    def test_extension_handling_for_opus(self):
        ...
        with patch('empath.audio_utils.torchaudio.save'):
            result = saver.save_audio(
                self.sample_audio,
                output_path,
                sample_rate=self.sample_rate,
