"""
FixedLoRATrainer -- Orchestration for Empath V2 adapter fine-tuning.
...
Uses shared utilities from ``empath.training``.
"""
...
from empath.training_v2.optim import build_optimizer, build_scheduler
from empath.training.data_module import PreprocessedDataModule

# V2 modules
from empath.training_v2.configs import TrainingConfigV2
from empath.training_v2.tensorboard_utils import TrainingLogger
from empath.training_v2.ui import TrainingUpdate

# Split-out modules
from empath.training_v2.fixed_lora_module import (
    AdapterConfig,
    FixedLoRAModule,
...
from empath.training_v2.trainer_helpers import (
...
from empath.training_v2.trainer_basic_loop import run_basic_training_loop
...
class FixedLoRATrainer:
    """High-level trainer for corrected Empath adapter fine-tuning.
    ...
    def _iter_module_wrappers(module: nn.Module) -> list:
        from empath.training_v2.trainer_helpers import iter_module_wrappers
