"""
Two-Pass CLI Preprocessing for Empath Training V2.
...
# Split-out helpers
from empath.training_v2.preprocess_discovery import (
...
from empath.training_v2.preprocess_prompt import (
    build_simple_prompt as _build_simple_prompt,
)
from empath.training_v2.preprocess_vae import (
...
def preprocess_audio_files(
    ...
    * **Audio directory** (fallback): scanned **recursively** for
    ...
    Args:
        ...
        checkpoint_dir: Path to Empath model checkpoints.
...
def _pass1_light(
    ...
    """
    from empath.training_v2.model_loader import (
        load_vae,
        load_text_encoder,
        load_silence_latent,
        unload_models,
    ...
    from empath.training.dataset_builder_modules.preprocess_audio import (
        load_audio_stereo,
    )
    from empath.training.dataset_builder_modules.preprocess_text import encode_text
    from empath.training.dataset_builder_modules.preprocess_lyrics import encode_lyrics
    ...
    # Dataset-level prompt settings from Empath's metadata block
...
def _pass2_heavy(
    ...
    from empath.training.dataset_builder_modules.preprocess_encoder import run_encoder
    from empath.training.dataset_builder_modules.preprocess_context import (
