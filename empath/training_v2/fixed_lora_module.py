"""
FixedLoRAModule -- Corrected adapter training step for Empath V2.
...
# V2 modules
from empath.training_v2.configs import LoRAConfigV2, LoKRConfigV2, TrainingConfigV2
from empath.training_v2.timestep_sampling import apply_cfg_dropout, sample_timesteps
    ...
    def training_step(self, batch: Dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        with autocast_ctx:
            ...
            t, r = sample_timesteps(
                ...
                use_meanflow=False,  # r = t for all Empath variants
            )
