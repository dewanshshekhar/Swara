...
The original ``empath/training/trainer.py`` ``LoRATrainer`` requires a
...
try:
    ...
    class LoRAConfig:  # type: ignore[no-redef]
        """Stub for ``empath.training.configs.LoRAConfig``."""
        r: int = 64
        alpha: int = 128
        dropout: float = 0.0
    ...
    class TrainingConfig:  # type: ignore[no-redef]
        """Stub for ``empath.training.configs.TrainingConfig``."""
...
class VanillaTrainer:
    ...
    def train(self) -> None:
        ...
        Raises:
            RuntimeError: If base Empath is not installed.
        """
