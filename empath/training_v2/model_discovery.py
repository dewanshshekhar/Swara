...
# Official Empath model directory name patterns.
_OFFICIAL_PREFIXES = ("empath-v15-", "empath-v1-")
...
def pick_model(
    ...
    from empath.training_v2.ui.prompt_helpers import GoBack, menu, ask
...
def _search_loop(models: List[ModelInfo]) -> Optional[Tuple[str, ModelInfo]]:
    ...
    from empath.training_v2.ui import console, is_rich_active
    from empath.training_v2.ui.prompt_helpers import GoBack, ask, menu
...
def prompt_base_model(model_name: str) -> str:
    ...
    """
    from empath.training_v2.ui import console, is_rich_active
    from empath.training_v2.ui.prompt_helpers import menu

    from empath.training_v2.ui.prompt_helpers import _esc
