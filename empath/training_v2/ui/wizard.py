"""
Interactive wizard for Empath Training V2.
...
from empath.training_v2.ui import console, is_rich_active
from empath.training_v2.ui.prompt_helpers import GoBack, menu
from empath.training_v2.ui.flows import wizard_train, wizard_preprocess
from empath.training_v2.ui.wizard_menus import experimental_menu, manage_presets_menu, _print_msg
...
def _ensure_first_run_done() -> None:
    ...
    from empath.training_v2.settings import is_first_run, save_settings
    from empath.training_v2.ui.flows_setup import run_first_setup
...
def run_wizard_session() -> Generator[argparse.Namespace, None, None]:
    ...
    from empath.training_v2.ui.prompt_helpers import ask_bool
...
def _run_settings_editor() -> None:
    ...
    from empath.training_v2.settings import save_settings
    from empath.training_v2.ui.flows_setup import run_settings_editor
