...
from empath.training_v2.ui.prompt_helpers import (
    _esc,
    ask_bool,
    ask_path,
    native_path,
...
def run_first_setup() -> dict:
    ...
    """
    from empath.training_v2.settings import _default_settings
    ...
    _print("     you want to train on (e.g. via [bold]empath-download[/] or manually).")
    ...
    _print("  [bold yellow]Vanilla[/] mode reproduces the original Empath training")
    ...
    _print("  [dim](Each model variant lives in its own subfolder, e.g.\n   checkpoints/empath-v15-turbo/, checkpoints/empath-v15-base/, etc.)[/]\n")
    ...
    while True:
        ...
        from empath.training_v2.model_discovery import scan_models
...
def run_settings_editor() -> dict | None:
    ...
    """
    from empath.training_v2.settings import load_settings
