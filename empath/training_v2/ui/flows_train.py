...
from empath.training_v2.ui.prompt_helpers import GoBack, _esc, menu, step_indicator
from empath.training_v2.ui.flows_common import build_train_namespace
from empath.training_v2.ui.flows_train_steps import (
    step_config_mode,
    step_required,
    step_lora,
    step_lokr,
...
def _offer_load_preset(answers: dict) -> None:
    ...
    from empath.training_v2.ui.presets import list_presets, load_preset
...
def _offer_save_preset(answers: dict) -> None:
    ...
    """
    from empath.training_v2.ui.presets import save_preset
    from empath.training_v2.ui.prompt_helpers import ask_bool, ask as _ask, section
