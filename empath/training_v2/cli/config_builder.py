"""
Config-object construction for Empath Training V2 CLI.
...
from empath.training_v2.cli.args import VARIANT_DIR_MAP
from empath.training_v2.cli.validation import resolve_target_modules
...
def build_configs(args: argparse.Namespace) -> Tuple[AdapterConfig, TrainingConfigV2]:
    ...
    if base_model and not model_config_path.is_file():
        from empath.training_v2.model_discovery import get_base_defaults
