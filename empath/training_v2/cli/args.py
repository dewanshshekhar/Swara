"""
Argparse construction for Empath Training V2 CLI.
...
def build_root_parser() -> argparse.ArgumentParser:
    ...
    try:
        from empath.training_v2.ui.help_formatter import RichHelpFormatter
    ...
    root = argparse.ArgumentParser(
        prog="train.py",
        description="Empath Training V2 -- corrected LoRA fine-tuning CLI",
