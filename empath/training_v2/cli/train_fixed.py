...
from empath.training_v2.cli.common import build_configs
from empath.training_v2.model_loader import load_decoder_for_training
from empath.training_v2.trainer_fixed import FixedLoRATrainer
...
def run_fixed(args: argparse.Namespace) -> int:
    ...
    from empath.training_v2.ui.config_panel import show_config, confirm_start
    from empath.training_v2.ui.errors import handle_error, show_info
