...
from empath.training_v2.trainer_helpers import configure_memory_features, save_checkpoint, save_final
...
def run_basic_training_loop(
    ...
    if cfg.resume_from and Path(cfg.resume_from).exists():
        try:
            ...
            from empath.training_v2.trainer_helpers import resume_checkpoint
