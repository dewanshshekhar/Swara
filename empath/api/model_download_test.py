...
from empath.api import model_download
...
class ModelDownloadTests(unittest.TestCase):
    ...
    def test_download_from_huggingface_uses_unified_repo_target_dir(self):
        ...
        self.assertEqual(os.path.join("checkpoints", "empath-v15-turbo"), out)
    ...
    def test_ensure_model_downloaded_returns_existing_model_path(self):
        ...
        with mock.patch("empath.api.model_download.os.path.exists", return_value=True), mock.patch(
            "empath.api.model_download.os.listdir",
            return_value=["weights.safetensors"],
        ), mock.patch("empath.api.model_download.download_from_huggingface") as hf_mock, mock.patch(
            "empath.api.model_download.download_from_modelscope"
        ) as ms_mock:
            out = model_download.ensure_model_downloaded("empath-v15-turbo", "checkpoints")
    ...
    def test_ensure_model_downloaded_uses_huggingface_when_env_prefers_it(self):
        ...
        with mock.patch.dict(os.environ, {"EMPATH_DOWNLOAD_SOURCE": "huggingface"}, clear=False), mock.patch(
            "empath.api.model_download.os.path.exists",
            return_value=False,
        ), mock.patch(
            "empath.api.model_download.download_from_huggingface",
    ...
    def test_ensure_model_downloaded_falls_back_to_modelscope_from_huggingface(self):
        ...
        with mock.patch.dict(os.environ, {"EMPATH_DOWNLOAD_SOURCE": ""}, clear=False), mock.patch(
            "empath.api.model_download.os.path.exists",
            return_value=False,
        ), mock.patch("empath.api.model_download.can_access_google", return_value=True), mock.patch(
            "empath.api.model_download.download_from_huggingface",
    ...
    def test_ensure_model_downloaded_falls_back_to_huggingface_from_modelscope(self):
        ...
        with mock.patch.dict(os.environ, {"EMPATH_DOWNLOAD_SOURCE": ""}, clear=False), mock.patch(
            "empath.api.model_download.os.path.exists",
            return_value=False,
        ), mock.patch("empath.api.model_download.can_access_google", return_value=False), mock.patch(
            "empath.api.model_download.download_from_modelscope",
