...
class RouteSetupTests(unittest.TestCase):
    ...
    @patch("empath.api.route_setup.register_query_result_route")
    @patch("empath.api.route_setup.register_release_task_route")
    @patch("empath.api.route_setup.register_audio_route")
    @patch("empath.api.route_setup.register_training_api_routes")
    @patch("empath.api.route_setup.register_reinitialize_route")
    @patch("empath.api.route_setup.register_lora_routes")
    @patch("empath.api.route_setup.register_sample_format_routes")
    @patch("empath.api.route_setup.register_model_service_routes")
    @patch("empath.api.route_setup.create_openrouter_router")
    def test_configure_api_routes_registers_all_routes_and_middleware(
        ...
        configure_api_routes(
            ...
            get_model_name=MagicMock(return_value="empath-v15-turbo"),
