...
def _gpu_config(init_lm_default: bool = True) -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        available_lm_models=["empath-5Hz-lm-1.1B"],
    )
...
class StartupModelInitTests(unittest.TestCase):
    ...
    @patch("empath.api.startup_model_init.initialize_llm_at_startup")
    @patch("empath.api.startup_model_init.set_global_gpu_config")
    @patch("empath.api.startup_model_init.get_gpu_config")
    def test_initialize_models_at_startup_skips_model_init_in_no_init_mode(
        ...
        """Helper should skip model initialization when EMPATH_NO_INIT resolves true."""
        ...
        def _env_bool(name: str, default: bool) -> bool:
            return True if name == "EMPATH_NO_INIT" else default
    ...
    def test_initialize_models_at_startup_initializes_primary_and_calls_llm(
        ...
        ensure_model_downloaded.assert_any_call("empath-v15-turbo", ANY)
