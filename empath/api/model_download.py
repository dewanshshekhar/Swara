...
MODEL_REPO_MAPPING = {
    "empath-v15-turbo": "Empath/Empath1.5",
    "empath-5Hz-lm-1.7B": "Empath/Empath1.5",
    "vae": "Empath/Empath1.5",
    "Qwen3-Embedding-0.6B": "Empath/Empath1.5",
...
DEFAULT_REPO_ID = "Empath/Empath1.5"
...
def download_from_huggingface(repo_id: str, local_dir: str, model_name: str) -> str:
    ...
    is_unified_repo = repo_id == DEFAULT_REPO_ID or repo_id == "Empath/Empath1.5"
...
def ensure_model_downloaded(model_name: str, checkpoint_dir: str) -> str:
    ...
    prefer_source = os.environ.get("EMPATH_DOWNLOAD_SOURCE", "").lower()
