    ...
    with lock:
        ...
        try:
            new_params = dict(restore_params) if restore_params else {
                ...
                "backend": os.getenv("EMPATH_LM_BACKEND", "vllm").strip().lower() or "vllm",
                "device": os.getenv("EMPATH_LM_DEVICE", os.getenv("EMPATH_DEVICE", "auto")),
                "offload_to_cpu": env_bool("EMPATH_LM_OFFLOAD_TO_CPU", False),
                "dtype": None,
            }
