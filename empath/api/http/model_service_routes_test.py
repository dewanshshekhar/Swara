...
from empath.api.http.model_service_routes import (
    InitModelRequest,
...
class ModelServiceRoutesTests(unittest.TestCase):
    ...
    def _build_app(self) -> FastAPI:
        ...
        app = FastAPI()
        app.state._config_path = "empath-v15-base"
        ...
        app.state.llm_handler = SimpleNamespace(last_init_params={"lm_model_path": "empath-5Hz-lm-1.7B"})
    ...
    def test_collect_model_inventory_merges_loaded_and_available_models(self):
        ...
        app = self._build_app()
        with mock.patch("empath.api.http.model_service_routes.os.path.isdir", return_value=True), mock.patch(
            "empath.api.http.model_service_routes.os.listdir",
            return_value=["empath-v15-base", "empath-v15-turbo", "empath-5Hz-lm-1.7B"],
        ):
        ...
        self.assertIn("empath-v15-base", names)
        self.assertIn("empath-v15-turbo", names)
        self.assertEqual("empath-v15-base", inventory["default_model"])
    ...
    def test_init_route_wraps_initializer_exception(self):
        ...
        request = InitModelRequest(model="empath-v15-base", init_llm=False, lm_model_path=None)

        with mock.patch("empath.api.http.model_service_routes.initialize_models_for_request", side_effect=RuntimeError("boom")):
