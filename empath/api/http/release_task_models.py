...
from empath.constants import DEFAULT_DIT_INSTRUCTION
...
class GenerateMusicRequest(BaseModel):
    ...
    model: Optional[str] = Field(default=None, description="Model name to use (e.g., 'empath-v15-turbo')")
    ...
    lm_model_path: Optional[str] = None  # e.g. "empath-5Hz-lm-0.6B"
