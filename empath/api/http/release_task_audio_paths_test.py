...
from empath.api.http.release_task_audio_paths import save_upload_to_temp, validate_audio_path
...
class ReleaseTaskAudioPathsTests(unittest.TestCase):
    ...
    def test_save_upload_to_temp_writes_file_and_closes_upload(self):
        ...
        with mock.patch(
            "empath.api.http.release_task_audio_paths.tempfile.mkstemp",
            return_value=(123, "mock/path/sample.wav"),
        ), mock.patch("empath.api.http.release_task_audio_paths.os.close") as close_mock, mock.patch(
            "empath.api.http.release_task_audio_paths.open",
