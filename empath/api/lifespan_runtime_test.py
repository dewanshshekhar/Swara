...
class LifespanRuntimeTests(unittest.TestCase):
    ...
    @patch("empath.api.lifespan_runtime._initialize_local_cache")
    @patch("empath.api.lifespan_runtime.os.makedirs")
    def test_initialize_lifespan_runtime_sets_expected_default_state(
        ...
        self.assertEqual("empath-v15-turbo", app.state._config_path)
    ...
    def test_initialize_lifespan_runtime_supports_secondary_and_third_model_handlers(
        ...
        with patch.dict(
            os.environ,
            {
                "EMPATH_TMPDIR": "k:/tmp/empath",
                "EMPATH_CONFIG_PATH2": "empath-v15-second",
                "EMPATH_CONFIG_PATH3": "empath-v15-third",
                "EMPATH_API_WORKERS": "3",
            },
            clear=True,
        ):
            runtime = initialize_lifespan_runtime(
            ...
            self.assertEqual("k:/tmp/empath", os.environ.get("TMPDIR"))

        self.assertIsNotNone(runtime.handler2)
        self.assertIsNotNone(runtime.handler3)
        self.assertEqual("empath-v15-second", runtime.config_path2)
        self.assertEqual("empath-v15-third", runtime.config_path3)
        self.assertEqual("empath-v15-second", app.state._config_path2)
        self.assertEqual("empath-v15-third", app.state._config_path3)
