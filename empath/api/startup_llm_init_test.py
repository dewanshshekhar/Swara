...
from empath.api.startup_llm_init import initialize_llm_at_startup
...
class StartupLlmInitTests(unittest.TestCase):
    ...
    def test_initialize_llm_at_startup_skips_when_disabled(self) -> None:
        ...
        with patch.dict(os.environ, {"EMPATH_INIT_LLM": "false"}, clear=True):
            initialize_llm_at_startup(
                ...
                get_model_name=MagicMock(return_value="empath-5Hz-lm-0.6B"),
    ...
    @patch("empath.api.startup_llm_init.is_lm_model_supported")
    @patch("empath.api.startup_llm_init.get_recommended_lm_model")
    def test_initialize_llm_at_startup_loads_recommended_model(
        ...
        mock_get_recommended_lm_model.return_value = "empath-5Hz-lm-1.1B"
        ...
        with patch.dict(os.environ, {}, clear=True):
            initialize_llm_at_startup(
                ...
                offload_to_cpu=False,
                checkpoint_dir="k:/repo/checkpoints",
                get_model_name=MagicMock(return_value="empath-5Hz-lm-1.1B"),
