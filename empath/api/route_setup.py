...
from empath.api.http.audio_route import register_audio_route
from empath.api.http.lora_routes import register_lora_routes
from empath.api.http.model_service_routes import register_model_service_routes
from empath.api.http.query_result_route import register_query_result_route
from empath.api.http.reinitialize_route import register_reinitialize_route
from empath.api.http.release_task_route import register_release_task_route
from empath.api.http.sample_format_routes import register_sample_format_routes
from empath.api.train_api_service import register_training_api_routes
from empath.openrouter_adapter import create_openrouter_router
