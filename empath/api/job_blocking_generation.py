...
from empath.api.job_analysis_runtime import maybe_handle_analysis_only_modes
from empath.api.job_generation_runtime import run_generation_with_optional_sequential_cover_mode
from empath.api.job_llm_preparation import (
    ensure_llm_ready_for_request,
    prepare_llm_generation_inputs,
)
from empath.api.job_runtime_state import update_progress_job_cache
from empath.api.job_result_payload import build_generation_success_response
from empath.api.job_generation_setup import build_generation_setup
...
def run_blocking_generate(
    *,
    ...
    lm_model_name = os.getenv("EMPATH_LM_MODEL_PATH", "empath-5Hz-lm-0.6B")
