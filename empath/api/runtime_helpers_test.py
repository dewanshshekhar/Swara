...
class RuntimeHelpersTests(unittest.TestCase):
    ...
    def test_start_tensorboard_starts_process_and_returns_url(self):
        ...
        with mock.patch("empath.api.runtime_helpers.os.getenv", return_value="6007"), mock.patch(
            "empath.api.runtime_helpers.sys.prefix", "venv-prefix"
        ), mock.patch("empath.api.runtime_helpers.sys.base_prefix", "base-prefix"), mock.patch(
            "empath.api.runtime_helpers.os.path.exists", return_value=False
        ), mock.patch(
            "empath.api.runtime_helpers.subprocess.Popen", return_value=fake_proc
        ):
    ...
    def test_start_tensorboard_returns_none_on_failure(self):
        ...
        app = SimpleNamespace(state=SimpleNamespace(tensorboard_process=None))
        with mock.patch(
            "empath.api.runtime_helpers.subprocess.Popen",
    ...
    def test_temporary_llm_model_switches_and_restores(self):
        ...
        with mock.patch("empath.api.runtime_helpers.os.makedirs"):
            with temporary_llm_model(
                app=app,
                llm=llm,
    ...
    def test_atomic_write_json_replaces_target_on_success(self):
        ...
        with mock.patch("empath.api.runtime_helpers.os.makedirs"), mock.patch(
            "empath.api.runtime_helpers.tempfile.mkstemp",
            return_value=(11, "tmp-file.json"),
        ), mock.patch("empath.api.runtime_helpers.os.fdopen", return_value=mock_context), mock.patch(
            "empath.api.runtime_helpers.json.dump"
        ), mock.patch(
            "empath.api.runtime_helpers.os.fsync"
        ) as fsync_mock, mock.patch(
            "empath.api.runtime_helpers.os.replace"
        ) as replace_mock:
    ...
    def test_atomic_write_json_cleans_tmp_file_on_error(self):
        ...
        ), mock.patch("empath.api.runtime_helpers.os.remove") as remove_mock:
    ...
    def test_append_jsonl_writes_one_line(self):
        ...
        with mock.patch("empath.api.runtime_helpers.os.makedirs"), mock.patch(
            "empath.api.runtime_helpers.json.dumps",
            return_value='{"a": 1}',
