...
class WorkerRuntimeTests(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("empath.api.worker_runtime.run_job_store_cleanup_loop", new_callable=AsyncMock)
    @patch("empath.api.worker_runtime.process_queue_item", new_callable=AsyncMock)
