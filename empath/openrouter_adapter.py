"""OpenRouter API adapter for Empath music generation.

This module provides OpenRouter-compatible endpoints that wrap the Empath
...
from empath.openrouter_models import (
    AudioConfig,
...
GENERATION_TIMEOUT = int(os.environ.get("EMPATH_GENERATION_TIMEOUT", "600"))
...
def _to_generate_music_request(
    ...
    """
    from empath.api_server import GenerateMusicRequest
