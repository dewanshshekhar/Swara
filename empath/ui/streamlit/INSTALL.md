...
- Empath main project installed (parent directory)
- pip or uv for package management

## Step 1: Install Dependencies

From the `empath/ui/streamlit` directory:
...
```bash
# Reinstall Empath dependencies
cd ..  # Go to main Empath dir
pip install -e .
```
