...
from empath.core.generation.handler.lyric_alignment_common import LyricAlignmentCommonMixin
...
class LyricTimestampMixin(LyricAlignmentCommonMixin):
    ...
    def get_lyric_timestamp(
        ...
        try:
            ...
            from empath.core.scoring.dit_alignment import MusicStampsAligner
