...
def _load_service_generate_module():
    """Load ``empath.core.generation.handler.service_generate`` from disk.
    ...
    Returns:
        ...
        ``empath.core.generation.handler.service_generate``.
    ...
    spec = importlib.util.spec_from_file_location("empath.core.generation.handler.service_generate", module_path)
