...
MLX_VAE_INIT_MODULE = _load_handler_module(
    "mlx_vae_init.py",
    "empath.core.generation.handler.mlx_vae_init",
)
...
class MlxVaeInitMixinTests(unittest.TestCase):
    ...
    def test_init_mlx_vae_unavailable_returns_false(self):
        ...
        host = _VaeHost()
        fake_mlx = types.ModuleType("empath.models.mlx")
        fake_mlx.mlx_available = lambda: False
        with patch.dict(sys.modules, {"empath.models.mlx": fake_mlx}):
    ...
    def test_init_mlx_vae_success_sets_compiled_callables(self):
        ...
        fake_vae_model = types.ModuleType("empath.models.mlx.vae_model")
        fake_vae_model.MLXAutoEncoderOobleck = _FakeMlxVae
        fake_vae_convert = types.ModuleType("empath.models.mlx.vae_convert")
        ...
        with patch.dict(
            sys.modules,
            {
                ...
                "empath.models.mlx": fake_mlx,
                "empath.models.mlx.vae_model": fake_vae_model,
                "empath.models.mlx.vae_convert": fake_vae_convert,
            },
        ):
            with patch.dict(os.environ, {"EMPATH_MLX_VAE_FP16": "0"}, clear=False):
