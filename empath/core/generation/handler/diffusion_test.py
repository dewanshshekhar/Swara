...
from empath.core.generation.handler.diffusion import DiffusionMixin
...
class DiffusionMixinTests(unittest.TestCase):
    def test_mlx_run_diffusion_converts_inputs_and_outputs_tensor(self):
        ...
        with patch("empath.core.generation.handler.diffusion.mlx_generate_diffusion", side_effect=_fake_generate):
