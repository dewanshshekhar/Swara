...
from empath.core.generation.handler.lyric_score import LyricScoreMixin
from empath.core.generation.handler.lyric_timestamp import LyricTimestampMixin
...
class LyricAlignmentMixinTests(unittest.TestCase):
    ...
    def test_get_lyric_timestamp_success(self):
        ...
        with patch.dict("sys.modules", {"empath.core.scoring.dit_alignment": fake_module}):
    ...
    def test_get_lyric_score_success(self):
        ...
        with patch.dict("sys.modules", {"empath.core.scoring.dit_score": fake_module}):
