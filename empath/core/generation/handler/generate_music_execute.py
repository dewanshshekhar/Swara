...
# GPUs can take several minutes.  Override via EMPATH_GENERATION_TIMEOUT env var.
_DEFAULT_GENERATION_TIMEOUT = int(os.environ.get("EMPATH_GENERATION_TIMEOUT", "600"))
