...
from empath.core.generation.handler.service_generate_execute import ServiceGenerateExecuteMixin
from empath.core.generation.handler.service_generate_outputs import ServiceGenerateOutputsMixin
...
class ServiceGenerateExecuteMixinTests(unittest.TestCase):
    ...
    def test_resolve_seed_param_none_uses_random_seed(self):
        ...
        host = _Host()
        with patch("empath.core.generation.handler.service_generate_execute.random.randint", return_value=42):
