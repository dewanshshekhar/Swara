...
class MlxVaeInitMixin:
    ...
    def _init_mlx_vae(self) -> bool:
        ...
        conversion based on ``EMPATH_MLX_VAE_FP16``, and prepares decode/encode
        callables.
        ...
        try:
            ...
            from empath.models.mlx.vae_model import MLXAutoEncoderOobleck
            from empath.models.mlx.vae_convert import convert_and_load

            mlx_vae = MLXAutoEncoderOobleck.from_pytorch_config(self.vae)
            convert_and_load(self.vae, mlx_vae)

            use_fp16 = os.environ.get("EMPATH_MLX_VAE_FP16", "0").lower() in (
                "1",
                "true",
                "yes",
            )
