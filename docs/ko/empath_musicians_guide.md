# Empath 1.5 — A Musician's Guide

## What Is This Thing?

Empath is a music-making AI that runs on your own computer. You describe the music you want — the style, the instruments, the mood, the lyrics — and it generates a full song in seconds. Not a loop, not a beat — a complete song with vocals, instruments, and structure.

Unlike cloud services like Suno or Udio, Empath runs locally. You own the software, you own the output, and you can use it offline with no subscription, no rate limits, and no terms of service restrictions.
...
Empath has two "brains" that work together, like a songwriter and a studio engineer:
...
Empath has six creative modes. Think of them like different tools in a studio:
...
1. Download the portable package from the Empath website (a single .7z file)
...
Step 2:  Download Empath from GitHub
Step 3:  Run "uv sync" to install everything
Step 4:  Run "uv run empath" to launch
...
When Empath opens in your browser, you get a web interface with three main areas:
...
The most important skill with Empath is learning how to describe what you want. You communicate through two main inputs:
...
Lyrics do double duty in Empath. They're not just words — they tell the AI how the song should be **structured** over time.
...
One of Empath's most powerful features is using existing audio to guide generation. There are three ways to do this:
...
LoRA is a way to teach Empath your personal sound. If you have a collection of songs that represent a style you want the AI to learn — your own recordings, a specific genre, a particular mood — you can train a custom "style adapter."
...
Empath can generate vocals in 50+ languages, including:
