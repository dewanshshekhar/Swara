...
- **ROCm Linux Setup:** See `docs/en/Empath1.5-Rocm-Manual-Linux.md`
...
| `EMPATH_LM_BACKEND` | Language model backend | `pt` (recommended for ROCm) |
...
| `EMPATH_VAE_ON_CPU` | Force VAE decode on CPU to save VRAM | `1` (enable) |
